...
/**
 * <p>Title:      自定义json jsonp 视图 spring 4.1 以后使用 AbstractJsonpResponseBodyAdvice 类实现jsonp. </p>
 * <p>Description TODO </p>
 * <p>Company:    https://www.sogou.com/ </p>
 *
 * @Author <a href="litaoos2862@sogou-inc.com"/>李涛</a>
 * @CreateDate 2017/6/27 16:14
 */
public class JsonpOrJsonView extends AbstractView {
    ...
    //枚举对象SerializerFeature 格式化数据时使用
